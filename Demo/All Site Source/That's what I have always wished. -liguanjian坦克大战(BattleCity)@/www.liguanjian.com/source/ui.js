    ...
    (function($) {
        $.fn.JSNESUI = function(roms) {
            ...
            var UI = function(nes) {
                 ...
                 * Create UI
                 */
                self.root = $('<div class="game_container"></div>');
                ...
                $('<div class="ctrl_press"><div style="margin-left: 54px;" id="tap_up">↑</div><br><div style="overflow: hidden;width: 186px;border: none;background: none;"><div style="float: left" id="tap_left">←</div><div style="float: right" id="tap_right">→</div></div><br><div style="margin-left: 55px;" id="tap_down">↓</div><div style="margin-left: 54px;float: right;margin-right: 10px;position: absolute;bottom: 20px;right: 0px;" id="tap_a">A</div><div style="margin-left: 54px;float: right;position: absolute;right: 10px;bottom: 116px;" id="tap_e">&#x21B4;</div></div>').appendTo(self.root);
                ...
                function setkey(em, code) {
                    em.on("touchstart", function () {
                        self.nes.keyboard.keyDown({keyCode:code});
                    });
                    em.on("touchend", function () {
                        self.nes.keyboard.keyUp({keyCode:code});
                    });
                }
                /*
                 * Sound
            ...
            UI.prototype = {    
                loadROM: function() {
                    ...
                    $.ajax({
                        ...
                        url: escape('roms/battlecity/Battle_City.nes'),
                        xhr: function() {
